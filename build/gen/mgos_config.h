...
/* cportal.rpc type struct mgos_config_cportal_rpc */
...
static inline bool mgos_config_cportal_rpc_parse(struct mg_str json, struct mgos_config_cportal_rpc *cfg) {
  mgos_config_cportal_rpc_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_cportal_rpc_get_schema(), cfg);
}
static inline bool mgos_config_cportal_rpc_emit(const struct mgos_config_cportal_rpc *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_cportal_rpc_get_schema(), pretty, out);
}
static inline bool mgos_config_cportal_rpc_emit_f(const struct mgos_config_cportal_rpc *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_cportal_rpc_get_schema(), pretty, fname);
}
static inline bool mgos_config_cportal_rpc_copy(const struct mgos_config_cportal_rpc *src, struct mgos_config_cportal_rpc *dst) {
  return mgos_conf_copy(mgos_config_cportal_rpc_get_schema(), src, dst);
}
static inline void mgos_config_cportal_rpc_free(struct mgos_config_cportal_rpc *cfg) {
  return mgos_conf_free(mgos_config_cportal_rpc_get_schema(), cfg);
}

/* cportal type struct mgos_config_cportal */
struct mgos_config_cportal {
  struct mgos_config_cportal_rpc rpc;
};
...
static inline bool mgos_config_cportal_parse(struct mg_str json, struct mgos_config_cportal *cfg) {
  mgos_config_cportal_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_cportal_get_schema(), cfg);
}
static inline bool mgos_config_cportal_emit(const struct mgos_config_cportal *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_cportal_get_schema(), pretty, out);
}
static inline bool mgos_config_cportal_emit_f(const struct mgos_config_cportal *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_cportal_get_schema(), pretty, fname);
}
static inline bool mgos_config_cportal_copy(const struct mgos_config_cportal *src, struct mgos_config_cportal *dst) {
  return mgos_conf_copy(mgos_config_cportal_get_schema(), src, dst);
}
static inline void mgos_config_cportal_free(struct mgos_config_cportal *cfg) {
  return mgos_conf_free(mgos_config_cportal_get_schema(), cfg);
}
...
/* app.par type struct mgos_config_app_par */
...
static inline bool mgos_config_app_par_parse(struct mg_str json, struct mgos_config_app_par *cfg) {
  mgos_config_app_par_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_app_par_get_schema(), cfg);
}
static inline bool mgos_config_app_par_emit(const struct mgos_config_app_par *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_app_par_get_schema(), pretty, out);
}
static inline bool mgos_config_app_par_emit_f(const struct mgos_config_app_par *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_app_par_get_schema(), pretty, fname);
}
static inline bool mgos_config_app_par_copy(const struct mgos_config_app_par *src, struct mgos_config_app_par *dst) {
  return mgos_conf_copy(mgos_config_app_par_get_schema(), src, dst);
}
static inline void mgos_config_app_par_free(struct mgos_config_app_par *cfg) {
  return mgos_conf_free(mgos_config_app_par_get_schema(), cfg);
}

/* app.pwm type struct mgos_config_app_pwm */
...
static inline bool mgos_config_app_pwm_parse(struct mg_str json, struct mgos_config_app_pwm *cfg) {
  mgos_config_app_pwm_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_app_pwm_get_schema(), cfg);
}
static inline bool mgos_config_app_pwm_emit(const struct mgos_config_app_pwm *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_app_pwm_get_schema(), pretty, out);
}
static inline bool mgos_config_app_pwm_emit_f(const struct mgos_config_app_pwm *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_app_pwm_get_schema(), pretty, fname);
}
static inline bool mgos_config_app_pwm_copy(const struct mgos_config_app_pwm *src, struct mgos_config_app_pwm *dst) {
  return mgos_conf_copy(mgos_config_app_pwm_get_schema(), src, dst);
}
static inline void mgos_config_app_pwm_free(struct mgos_config_app_pwm *cfg) {
  return mgos_conf_free(mgos_config_app_pwm_get_schema(), cfg);
}

/* app.mode type struct mgos_config_app_mode */
...
static inline bool mgos_config_app_mode_parse(struct mg_str json, struct mgos_config_app_mode *cfg) {
  mgos_config_app_mode_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_app_mode_get_schema(), cfg);
}
static inline bool mgos_config_app_mode_emit(const struct mgos_config_app_mode *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_app_mode_get_schema(), pretty, out);
}
static inline bool mgos_config_app_mode_emit_f(const struct mgos_config_app_mode *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_app_mode_get_schema(), pretty, fname);
}
static inline bool mgos_config_app_mode_copy(const struct mgos_config_app_mode *src, struct mgos_config_app_mode *dst) {
  return mgos_conf_copy(mgos_config_app_mode_get_schema(), src, dst);
}
static inline void mgos_config_app_mode_free(struct mgos_config_app_mode *cfg) {
  return mgos_conf_free(mgos_config_app_mode_get_schema(), cfg);
}

/* app.cfg type struct mgos_config_app_cfg */
...
static inline bool mgos_config_app_cfg_parse(struct mg_str json, struct mgos_config_app_cfg *cfg) {
  mgos_config_app_cfg_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_app_cfg_get_schema(), cfg);
}
static inline bool mgos_config_app_cfg_emit(const struct mgos_config_app_cfg *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_app_cfg_get_schema(), pretty, out);
}
static inline bool mgos_config_app_cfg_emit_f(const struct mgos_config_app_cfg *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_app_cfg_get_schema(), pretty, fname);
}
static inline bool mgos_config_app_cfg_copy(const struct mgos_config_app_cfg *src, struct mgos_config_app_cfg *dst) {
  return mgos_conf_copy(mgos_config_app_cfg_get_schema(), src, dst);
}
static inline void mgos_config_app_cfg_free(struct mgos_config_app_cfg *cfg) {
  return mgos_conf_free(mgos_config_app_cfg_get_schema(), cfg);
}

/* app.night type struct mgos_config_app_night */
...
static inline bool mgos_config_app_night_parse(struct mg_str json, struct mgos_config_app_night *cfg) {
  mgos_config_app_night_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_app_night_get_schema(), cfg);
}
static inline bool mgos_config_app_night_emit(const struct mgos_config_app_night *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_app_night_get_schema(), pretty, out);
}
static inline bool mgos_config_app_night_emit_f(const struct mgos_config_app_night *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_app_night_get_schema(), pretty, fname);
}
static inline bool mgos_config_app_night_copy(const struct mgos_config_app_night *src, struct mgos_config_app_night *dst) {
  return mgos_conf_copy(mgos_config_app_night_get_schema(), src, dst);
}
static inline void mgos_config_app_night_free(struct mgos_config_app_night *cfg) {
  return mgos_conf_free(mgos_config_app_night_get_schema(), cfg);
}

/* app.old type struct mgos_config_app_old */
...
static inline bool mgos_config_app_old_parse(struct mg_str json, struct mgos_config_app_old *cfg) {
  mgos_config_app_old_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_app_old_get_schema(), cfg);
}
static inline bool mgos_config_app_old_emit(const struct mgos_config_app_old *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_app_old_get_schema(), pretty, out);
}
static inline bool mgos_config_app_old_emit_f(const struct mgos_config_app_old *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_app_old_get_schema(), pretty, fname);
}
static inline bool mgos_config_app_old_copy(const struct mgos_config_app_old *src, struct mgos_config_app_old *dst) {
  return mgos_conf_copy(mgos_config_app_old_get_schema(), src, dst);
}
static inline void mgos_config_app_old_free(struct mgos_config_app_old *cfg) {
  return mgos_conf_free(mgos_config_app_old_get_schema(), cfg);
}

/* app.boost type struct mgos_config_app_boost */
...
static inline bool mgos_config_app_boost_parse(struct mg_str json, struct mgos_config_app_boost *cfg) {
  mgos_config_app_boost_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_app_boost_get_schema(), cfg);
}
static inline bool mgos_config_app_boost_emit(const struct mgos_config_app_boost *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_app_boost_get_schema(), pretty, out);
}
static inline bool mgos_config_app_boost_emit_f(const struct mgos_config_app_boost *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_app_boost_get_schema(), pretty, fname);
}
static inline bool mgos_config_app_boost_copy(const struct mgos_config_app_boost *src, struct mgos_config_app_boost *dst) {
  return mgos_conf_copy(mgos_config_app_boost_get_schema(), src, dst);
}
static inline void mgos_config_app_boost_free(struct mgos_config_app_boost *cfg) {
  return mgos_conf_free(mgos_config_app_boost_get_schema(), cfg);
}

/* app type struct mgos_config_app */
struct mgos_config_app {
  struct mgos_config_app_par par;
  int pin;
  const char * user;
  const char * home;
  const char * name;
  struct mgos_config_app_pwm pwm;
  struct mgos_config_app_mode mode;
  struct mgos_config_app_cfg cfg;
  struct mgos_config_app_night night;
  struct mgos_config_app_old old;
  struct mgos_config_app_boost boost;
};
...
struct mgos_config {
  ...
  struct mgos_config_cportal cportal;
...
/* cportal */
#define MGOS_CONFIG_HAVE_CPORTAL
#define MGOS_SYS_CONFIG_HAVE_CPORTAL
const struct mgos_config_cportal *mgos_config_get_cportal(const struct mgos_config *cfg);
static inline const struct mgos_config_cportal *mgos_sys_config_get_cportal(void) { return mgos_config_get_cportal(&mgos_sys_config); }

/* cportal.rpc */
#define MGOS_CONFIG_HAVE_CPORTAL_RPC
#define MGOS_SYS_CONFIG_HAVE_CPORTAL_RPC
const struct mgos_config_cportal_rpc *mgos_config_get_cportal_rpc(const struct mgos_config *cfg);
static inline const struct mgos_config_cportal_rpc *mgos_sys_config_get_cportal_rpc(void) { return mgos_config_get_cportal_rpc(&mgos_sys_config); }

/* cportal.rpc.enable */
#define MGOS_CONFIG_HAVE_CPORTAL_RPC_ENABLE
#define MGOS_SYS_CONFIG_HAVE_CPORTAL_RPC_ENABLE
int mgos_config_get_cportal_rpc_enable(const struct mgos_config *cfg);
int mgos_config_get_default_cportal_rpc_enable(void);
static inline int mgos_sys_config_get_cportal_rpc_enable(void) { return mgos_config_get_cportal_rpc_enable(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_cportal_rpc_enable(void) { return mgos_config_get_default_cportal_rpc_enable(); }
void mgos_config_set_cportal_rpc_enable(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_cportal_rpc_enable(int v) { mgos_config_set_cportal_rpc_enable(&mgos_sys_config, v); }

/* cportal.rpc.disable */
#define MGOS_CONFIG_HAVE_CPORTAL_RPC_DISABLE
#define MGOS_SYS_CONFIG_HAVE_CPORTAL_RPC_DISABLE
int mgos_config_get_cportal_rpc_disable(const struct mgos_config *cfg);
int mgos_config_get_default_cportal_rpc_disable(void);
static inline int mgos_sys_config_get_cportal_rpc_disable(void) { return mgos_config_get_cportal_rpc_disable(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_cportal_rpc_disable(void) { return mgos_config_get_default_cportal_rpc_disable(); }
void mgos_config_set_cportal_rpc_disable(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_cportal_rpc_disable(int v) { mgos_config_set_cportal_rpc_disable(&mgos_sys_config, v); }

/* cportal.rpc.apsta */
#define MGOS_CONFIG_HAVE_CPORTAL_RPC_APSTA
#define MGOS_SYS_CONFIG_HAVE_CPORTAL_RPC_APSTA
int mgos_config_get_cportal_rpc_apsta(const struct mgos_config *cfg);
int mgos_config_get_default_cportal_rpc_apsta(void);
static inline int mgos_sys_config_get_cportal_rpc_apsta(void) { return mgos_config_get_cportal_rpc_apsta(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_cportal_rpc_apsta(void) { return mgos_config_get_default_cportal_rpc_apsta(); }
void mgos_config_set_cportal_rpc_apsta(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_cportal_rpc_apsta(int v) { mgos_config_set_cportal_rpc_apsta(&mgos_sys_config, v); }
...
/* app.par */
#define MGOS_CONFIG_HAVE_APP_PAR
#define MGOS_SYS_CONFIG_HAVE_APP_PAR
const struct mgos_config_app_par *mgos_config_get_app_par(const struct mgos_config *cfg);
static inline const struct mgos_config_app_par *mgos_sys_config_get_app_par(void) { return mgos_config_get_app_par(&mgos_sys_config); }
...
/* app.user */
#define MGOS_CONFIG_HAVE_APP_USER
#define MGOS_SYS_CONFIG_HAVE_APP_USER
const char * mgos_config_get_app_user(const struct mgos_config *cfg);
const char * mgos_config_get_default_app_user(void);
static inline const char * mgos_sys_config_get_app_user(void) { return mgos_config_get_app_user(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_app_user(void) { return mgos_config_get_default_app_user(); }
void mgos_config_set_app_user(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_app_user(const char * v) { mgos_config_set_app_user(&mgos_sys_config, v); }

/* app.home */
#define MGOS_CONFIG_HAVE_APP_HOME
#define MGOS_SYS_CONFIG_HAVE_APP_HOME
const char * mgos_config_get_app_home(const struct mgos_config *cfg);
const char * mgos_config_get_default_app_home(void);
static inline const char * mgos_sys_config_get_app_home(void) { return mgos_config_get_app_home(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_app_home(void) { return mgos_config_get_default_app_home(); }
void mgos_config_set_app_home(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_app_home(const char * v) { mgos_config_set_app_home(&mgos_sys_config, v); }
...
/* app.pwm */
#define MGOS_CONFIG_HAVE_APP_PWM
#define MGOS_SYS_CONFIG_HAVE_APP_PWM
const struct mgos_config_app_pwm *mgos_config_get_app_pwm(const struct mgos_config *cfg);
static inline const struct mgos_config_app_pwm *mgos_sys_config_get_app_pwm(void) { return mgos_config_get_app_pwm(&mgos_sys_config); }

/* app.pwm.time */
#define MGOS_CONFIG_HAVE_APP_PWM_TIME
#define MGOS_SYS_CONFIG_HAVE_APP_PWM_TIME
int mgos_config_get_app_pwm_time(const struct mgos_config *cfg);
int mgos_config_get_default_app_pwm_time(void);
static inline int mgos_sys_config_get_app_pwm_time(void) { return mgos_config_get_app_pwm_time(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_pwm_time(void) { return mgos_config_get_default_app_pwm_time(); }
void mgos_config_set_app_pwm_time(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_pwm_time(int v) { mgos_config_set_app_pwm_time(&mgos_sys_config, v); }

/* app.pwm.val */
#define MGOS_CONFIG_HAVE_APP_PWM_VAL
#define MGOS_SYS_CONFIG_HAVE_APP_PWM_VAL
int mgos_config_get_app_pwm_val(const struct mgos_config *cfg);
int mgos_config_get_default_app_pwm_val(void);
static inline int mgos_sys_config_get_app_pwm_val(void) { return mgos_config_get_app_pwm_val(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_pwm_val(void) { return mgos_config_get_default_app_pwm_val(); }
void mgos_config_set_app_pwm_val(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_pwm_val(int v) { mgos_config_set_app_pwm_val(&mgos_sys_config, v); }

/* app.pwm.gra */
#define MGOS_CONFIG_HAVE_APP_PWM_GRA
#define MGOS_SYS_CONFIG_HAVE_APP_PWM_GRA
int mgos_config_get_app_pwm_gra(const struct mgos_config *cfg);
int mgos_config_get_default_app_pwm_gra(void);
static inline int mgos_sys_config_get_app_pwm_gra(void) { return mgos_config_get_app_pwm_gra(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_pwm_gra(void) { return mgos_config_get_default_app_pwm_gra(); }
void mgos_config_set_app_pwm_gra(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_pwm_gra(int v) { mgos_config_set_app_pwm_gra(&mgos_sys_config, v); }

/* app.pwm.night */
#define MGOS_CONFIG_HAVE_APP_PWM_NIGHT
#define MGOS_SYS_CONFIG_HAVE_APP_PWM_NIGHT
int mgos_config_get_app_pwm_night(const struct mgos_config *cfg);
int mgos_config_get_default_app_pwm_night(void);
static inline int mgos_sys_config_get_app_pwm_night(void) { return mgos_config_get_app_pwm_night(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_pwm_night(void) { return mgos_config_get_default_app_pwm_night(); }
void mgos_config_set_app_pwm_night(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_pwm_night(int v) { mgos_config_set_app_pwm_night(&mgos_sys_config, v); }

/* app.mode */
#define MGOS_CONFIG_HAVE_APP_MODE
#define MGOS_SYS_CONFIG_HAVE_APP_MODE
const struct mgos_config_app_mode *mgos_config_get_app_mode(const struct mgos_config *cfg);
static inline const struct mgos_config_app_mode *mgos_sys_config_get_app_mode(void) { return mgos_config_get_app_mode(&mgos_sys_config); }

/* app.mode.night */
#define MGOS_CONFIG_HAVE_APP_MODE_NIGHT
#define MGOS_SYS_CONFIG_HAVE_APP_MODE_NIGHT
int mgos_config_get_app_mode_night(const struct mgos_config *cfg);
int mgos_config_get_default_app_mode_night(void);
static inline int mgos_sys_config_get_app_mode_night(void) { return mgos_config_get_app_mode_night(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_mode_night(void) { return mgos_config_get_default_app_mode_night(); }
void mgos_config_set_app_mode_night(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_mode_night(int v) { mgos_config_set_app_mode_night(&mgos_sys_config, v); }

/* app.mode.avto */
#define MGOS_CONFIG_HAVE_APP_MODE_AVTO
#define MGOS_SYS_CONFIG_HAVE_APP_MODE_AVTO
int mgos_config_get_app_mode_avto(const struct mgos_config *cfg);
int mgos_config_get_default_app_mode_avto(void);
static inline int mgos_sys_config_get_app_mode_avto(void) { return mgos_config_get_app_mode_avto(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_mode_avto(void) { return mgos_config_get_default_app_mode_avto(); }
void mgos_config_set_app_mode_avto(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_mode_avto(int v) { mgos_config_set_app_mode_avto(&mgos_sys_config, v); }

/* app.mode.boost */
#define MGOS_CONFIG_HAVE_APP_MODE_BOOST
#define MGOS_SYS_CONFIG_HAVE_APP_MODE_BOOST
int mgos_config_get_app_mode_boost(const struct mgos_config *cfg);
int mgos_config_get_default_app_mode_boost(void);
static inline int mgos_sys_config_get_app_mode_boost(void) { return mgos_config_get_app_mode_boost(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_mode_boost(void) { return mgos_config_get_default_app_mode_boost(); }
void mgos_config_set_app_mode_boost(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_mode_boost(int v) { mgos_config_set_app_mode_boost(&mgos_sys_config, v); }

/* app.mode.summer */
#define MGOS_CONFIG_HAVE_APP_MODE_SUMMER
#define MGOS_SYS_CONFIG_HAVE_APP_MODE_SUMMER
int mgos_config_get_app_mode_summer(const struct mgos_config *cfg);
int mgos_config_get_default_app_mode_summer(void);
static inline int mgos_sys_config_get_app_mode_summer(void) { return mgos_config_get_app_mode_summer(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_mode_summer(void) { return mgos_config_get_default_app_mode_summer(); }
void mgos_config_set_app_mode_summer(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_mode_summer(int v) { mgos_config_set_app_mode_summer(&mgos_sys_config, v); }

/* app.cfg */
#define MGOS_CONFIG_HAVE_APP_CFG
#define MGOS_SYS_CONFIG_HAVE_APP_CFG
const struct mgos_config_app_cfg *mgos_config_get_app_cfg(const struct mgos_config *cfg);
static inline const struct mgos_config_app_cfg *mgos_sys_config_get_app_cfg(void) { return mgos_config_get_app_cfg(&mgos_sys_config); }

/* app.cfg.rst */
#define MGOS_CONFIG_HAVE_APP_CFG_RST
#define MGOS_SYS_CONFIG_HAVE_APP_CFG_RST
int mgos_config_get_app_cfg_rst(const struct mgos_config *cfg);
int mgos_config_get_default_app_cfg_rst(void);
static inline int mgos_sys_config_get_app_cfg_rst(void) { return mgos_config_get_app_cfg_rst(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_cfg_rst(void) { return mgos_config_get_default_app_cfg_rst(); }
void mgos_config_set_app_cfg_rst(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_cfg_rst(int v) { mgos_config_set_app_cfg_rst(&mgos_sys_config, v); }

/* app.night */
#define MGOS_CONFIG_HAVE_APP_NIGHT
#define MGOS_SYS_CONFIG_HAVE_APP_NIGHT
const struct mgos_config_app_night *mgos_config_get_app_night(const struct mgos_config *cfg);
static inline const struct mgos_config_app_night *mgos_sys_config_get_app_night(void) { return mgos_config_get_app_night(&mgos_sys_config); }

/* app.night.speed */
#define MGOS_CONFIG_HAVE_APP_NIGHT_SPEED
#define MGOS_SYS_CONFIG_HAVE_APP_NIGHT_SPEED
int mgos_config_get_app_night_speed(const struct mgos_config *cfg);
int mgos_config_get_default_app_night_speed(void);
static inline int mgos_sys_config_get_app_night_speed(void) { return mgos_config_get_app_night_speed(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_night_speed(void) { return mgos_config_get_default_app_night_speed(); }
void mgos_config_set_app_night_speed(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_night_speed(int v) { mgos_config_set_app_night_speed(&mgos_sys_config, v); }

/* app.old */
#define MGOS_CONFIG_HAVE_APP_OLD
#define MGOS_SYS_CONFIG_HAVE_APP_OLD
const struct mgos_config_app_old *mgos_config_get_app_old(const struct mgos_config *cfg);
static inline const struct mgos_config_app_old *mgos_sys_config_get_app_old(void) { return mgos_config_get_app_old(&mgos_sys_config); }

/* app.old.speed */
#define MGOS_CONFIG_HAVE_APP_OLD_SPEED
#define MGOS_SYS_CONFIG_HAVE_APP_OLD_SPEED
int mgos_config_get_app_old_speed(const struct mgos_config *cfg);
int mgos_config_get_default_app_old_speed(void);
static inline int mgos_sys_config_get_app_old_speed(void) { return mgos_config_get_app_old_speed(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_old_speed(void) { return mgos_config_get_default_app_old_speed(); }
void mgos_config_set_app_old_speed(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_old_speed(int v) { mgos_config_set_app_old_speed(&mgos_sys_config, v); }

/* app.boost */
#define MGOS_CONFIG_HAVE_APP_BOOST
#define MGOS_SYS_CONFIG_HAVE_APP_BOOST
const struct mgos_config_app_boost *mgos_config_get_app_boost(const struct mgos_config *cfg);
static inline const struct mgos_config_app_boost *mgos_sys_config_get_app_boost(void) { return mgos_config_get_app_boost(&mgos_sys_config); }

/* app.boost.time */
#define MGOS_CONFIG_HAVE_APP_BOOST_TIME
#define MGOS_SYS_CONFIG_HAVE_APP_BOOST_TIME
int mgos_config_get_app_boost_time(const struct mgos_config *cfg);
int mgos_config_get_default_app_boost_time(void);
static inline int mgos_sys_config_get_app_boost_time(void) { return mgos_config_get_app_boost_time(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_boost_time(void) { return mgos_config_get_default_app_boost_time(); }
void mgos_config_set_app_boost_time(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_boost_time(int v) { mgos_config_set_app_boost_time(&mgos_sys_config, v); }
